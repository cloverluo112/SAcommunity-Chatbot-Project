...
$(document).ready(function() {
	...
	$('a').each(function(i) {
		...
		if (href && href.indexOf('http:') == 0 && href.indexOf(root) != 0) {
...
;!function($, window, undefined) {
	...
	function key_in(e) {
		var val = $s.val();
		if (!val || val.length < 3) {
      $('.region-navigation .ac').removeClass('active');
			return;
		}
	...
	function ajax_succ(data, ts, jqxhr) {
		// console.log('html', data);
    $('.region-navigation .ac').html(data).addClass('active');
	}

	function init() {
		$form = $('#-cu-display-search-block-form');
		$s = $form.find('#edit-s');
		$loc = $form.find('#edit-location');
		$s.bind('keyup', key_in);
	}
...
;jQuery(function($){
	$('.print-org').click(function(e) {
		var $b = $('body').toggleClass('print');
		if ($(this).hasClass('no-map')) {
			$b.addClass('print-no-map');
		} else {
			$b.removeClass('print-no-map');
		}
		print();
	});
	$('.print-org').click(function(e) {
  ...
  $('.control-icons').each(function(k,v) {
    $('.print', this).click(function(e) {
      $('body').toggleClass('print');
    });
    $('.contrast', this).click(function(e) {
      $('body').toggleClass('contrast');
      $.cookie('contrast',$('body').hasClass('contrast')?1:0);
    });
    $('.print', this).click(function(e) {
      print();
    });
    $('.enlarge', this).click(function(e) {
      $('body').toggleClass('enlarge');
      $.cookie('enlarge',$('body').hasClass('enlarge')?1:0);
    });
  });

  $('.front .deco, .sidebar .deco').click(function() { 
    $(this).parent().toggleClass('active');
    $(this).parent().siblings().removeClass('active');
    $('ul.directory li.active',$(this).parent().parent().parent().siblings()).removeClass('active');
    /*
    $('.front .deco, .sidebar .deco').click(function() {
  ...
  $('.activep').parent().addClass('active');

  /**
   * jQuery placeholder plugin for older browsers doesn't support html5 placeholder attribute
   */
  $('input, textarea').placeholder();

  /**
  * menu (in case we are a tablet should not accept clicks for the first time on expandable menu items)
  */
  $('.sf-primary-links a').bind('mousedown touchstart', function(e) {
...
function writeViewPort() {
    ...
    if (ua.indexOf("Firefox") >= 0) {
        ...
        document.write('<meta name="viewport" content="width=640, user-scalable=no, initial-scale=' + scale + '" />');
    }
...
function _sa_tc(classname) {
  var a = ['menu','search','login'];
  var $mp = $('#mparent');
  $.each(a, function(l,v) {
    if (classname!=v) {
      $mp.removeClass(v);
...
function preloadImages() {
	for (i = 0; i < preloadImages.arguments.length; i++) {
		...
		window.images[i].src = preloadImages.arguments[i];
	}
};

preloadImages("/img/footer-icons-inverse.png");
writeViewPort();
...
!function(a){"function"==typeof define&&define.amd?define(["jquery"],a):"object"==typeof exports?a(require("jquery")):a(jQuery)}(function(a){function b(a){return h.raw?a:encodeURIComponent(a)}function c(a){return h.raw?a:decodeURIComponent(a)}function d(a){return b(h.json?JSON.stringify(a):String(a))}function e(a){0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return a=decodeURIComponent(a.replace(g," ")),h.json?JSON.parse(a):a}catch(b){}}function f(b,c){var d=h.raw?b:e(b);return a.isFunction(c)?c(d):d}var g=/\+/g,h=a.cookie=function(e,g,i){if(void 0!==g&&!a.isFunction(g)){if(i=a.extend({},h.defaults,i),"number"==typeof i.expires){var j=i.expires,k=i.expires=new Date;k.setTime(+k+864e5*j)}return document.cookie=[b(e),"=",d(g),i.expires?"; expires="+i.expires.toUTCString():"",i.path?"; path="+i.path:"",i.domain?"; domain="+i.domain:"",i.secure?"; secure":""].join("")}for(var l=e?void 0:{},m=document.cookie?document.cookie.split("; "):[],n=0,o=m.length;o>n;n++){var p=m[n].split("="),q=c(p.shift()),r=p.join("=");if(e&&e===q){l=f(r,g);break}e||void 0===(r=f(r))||(l[q]=r)}return l};h.defaults={},a.removeCookie=function(b,c){return void 0===a.cookie(b)?!1:(a.cookie(b,"",a.extend({},c,{expires:-1})),!a.cookie(b))}});;jQuery.fn.extend({
    placeholder: function(){
        if(!nwsPlaceholder.isSupported()){
            nwsPlaceholder.fill($(this));
            $(this).focus(function(){
                nwsPlaceholder.empty($(this));
            });
            $(this).blur(function(){
                nwsPlaceholder.fill($(this));
            });
...
nwsPlaceholder              ={};
nwsPlaceholder.attr         ='placeholder';
nwsPlaceholder.isSupported  =function(){
    return 'placeholder' in document.createElement('input');
};
nwsPlaceholder.fill         =function(e){
   e.each(function(){
     if($(this).attr(nwsPlaceholder.attr)!='' && $(this).val()==''){
       $(this).val($(this).attr(nwsPlaceholder.attr));
     }
   });
};
nwsPlaceholder.empty        =function(e){
    e.each(function(){
      if($(this).attr(nwsPlaceholder.attr)!='' && $(this).val()==$(this).attr(nwsPlaceholder.attr)){
        $(this).val('');
      }
    });
};
